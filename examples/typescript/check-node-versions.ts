...
console.log(
  'OpenAPI Spec Version: 1.1.0 (from tools/codegen/fixtures/openapi-baseline.json)'
);
...
console.log(
  'Schema mismatches may occur when the spec is newer than the deployed nodes.'
);
