...
// Generated on: 2025-08-01T18:18:14.507Z
...
export const GenesisConfigRequestSchema = () =>
  z.record(z.string(), z.unknown());
...
export const RpcClientConfigRequestSchema = () =>
  z.record(z.string(), z.unknown());
...
export const RpcNetworkInfoRequestSchema = () =>
  z.record(z.string(), z.unknown());
